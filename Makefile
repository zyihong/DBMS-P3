...
submit:
	tar -zcvf project3.tar.gz GetData.java query1.js query2.js query3.js query4.js query5.js query6.js query7.js query8.js query9.js
	@echo "A project3.tar.gx has been created. If there are errors, then"
	@echo "Make sure you have all the required files."
	@echo "Even if you are working as a group, each partner must submit"
	@echo "separately."
	@echo  "Submit project3.tar.gz at https://grader484.eecs.umich.edu"
